		...
		<div class="shop_hd_topNav">
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_left">
					<p>您好，欢迎来到<b><a href="/">网上商城</a></b>[<a href="${pageContext.request.contextPath}/user/login.jsp">登录</a>][<a href="${pageContext.request.contextPath}/user/register">注册</a>]</p>
				</div>
