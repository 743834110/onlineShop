...
<body>
		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="#" class="tip-bottom">商品种类信息</a>
				<a href="#" class="current">商品种类信息</a>
			</div>
			<div class="widget-box">
							...
							<div class="widget-content nopadding">
								...
								<table class="table table-bordered data-table">
									...
									<tbody>
										<c:forEach items="${loadCategory}" var="category">
											<tr class="gradeU">
												<td>${category.id}</td>
												<td>${category.categoryof}</td>
												<td>${category.fromTable}</td>
										</c:forEach>
									</tbody>
								</table>  
							</div>
