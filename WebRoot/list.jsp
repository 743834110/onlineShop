		...
		<div class="shop_bd_list_right clearfix">
			...
			<div class="shop_bd_list_content clearfix">
				<ul>
					...
					<li>
						<dl>
							<dt><a href=""><img src="${pageContext.request.contextPath}/<s:if test="%{productImages.size != 0}"><s:property value = "productImages.get(0).path"/></s:if><s:else>upload/goods/夏目.jpg</s:else>" /></a></dt>
