...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/js/yuan.js"></script>
	...
	<div class="shop_gwc_bd clearfix">
		<div class="shop_gwc_bd_contents clearfix">
			...
			<div class="shop_bd_shdz_title">
				<h3>收货人地址</h3>
				<p>
					<a href="javasrcipt:void(0);" id="new_add_shdz_btn">新增收货地址</a> <a
						href="${pageContext.request.contextPath}/user/toaddress">管理收货地址</a>
				</p>
			</div>
			<div class="clear"></div>
			<!-- 收货人地址 Title End -->
							...
							<ul>
								<c:forEach items="${addressList}" var="address">
									<li><label>寄送至：<span><input type="radio"
												name="address.id" value="${address.id}" /></span></label> <em>${address.extra }</em>
										<em>${address.username }收</em> <em>联系电话：${address.telephone }</em>
									</li>
								</c:forEach>
								<li style="text-align: center;"><a
									href="${pageContext.request.contextPath}/user/topay?pageNo=1"><em>首页</em></a>
									<a
									href="${pageContext.request.contextPath}/user/topay?pageNo=${prevpage}"><em>上一页</em></a>
									<a href="javascript:void(0);">${pageNo }</a> <a
									href="${pageContext.request.contextPath}/user/topay?pageNo=${nextpage}"><em>下一页</em></a>
									<a
									href="${pageContext.request.contextPath}/user/topay?pageNo=${allpage}"><em>尾页</em></a>
									<em>一共${allpage}页<em></li>
							</ul>
						</c:if>
				</div>
				<!-- 新增收货地址 -->
					...
					<div class="shdz_new_form">
						<ul>
							...
							<li><label for=""><span>*</span>联系电话：</label><input
								id="telephone" type="text" class="dianhua"
								name="address.telephone" /></li>
							<li><label for=""><span></span>邮政编码：</label><input
								id="youbian" type="text" class="youbian" name="address.postcode" /></li>
							<li><label for="">&nbsp;</label><input id="addAddress"
								type="button" value="增加收货地址" /></li>
						</ul>
					</div>
				</div>
				<!-- 新增收货地址 End -->
				...
				<tbody>
					<c:forEach items="${cartList}" var="cartExample" varStatus="statu">
						<tr>
							...
							<td class="gwc_list_caozuo"><a href="">收藏</a> <!--  <a href="javascript:void(0)" class="shop_good_delete">删除</a> -->
							</td>
						</tr>
					</c:forEach>
				</tbody>
					...
					<tr>
						<td colspan="6">
							<div class="gwc_foot_zongjia">
								商品总价(不含运费)<span>￥<strong id="good_zongjia">${allprice}</strong></span>
							</div>
							<div class="clear"></div>
							<div class="gwc_foot_links">
								<a href="${pageContext.request.contextPath}/user/tocart"
									class="go">返回上一步</a> <a href="javascript:void(0)" class="op"
									id="op">确认收货地址</a>
							</div>
						</td>
					</tr>
